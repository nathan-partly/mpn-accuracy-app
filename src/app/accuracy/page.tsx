    ...
    <div className="max-w-7xl mx-auto px-6 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-grey-400 text-sm mt-1">
          MPN accuracy validation across all benchmarked brands · <Link href="/upload" className="text-brand-blue hover:underline">re-upload your master CSV</Link> to add a new snapshot
        </p>
      </div>
